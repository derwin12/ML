...
from utils import indent, load_structure_map, get_audio_duration, get_eligible_models, sort_models, update_metadata, \
    ...
    categorize_models, add_everything_group_effect, EffectDBRegistry, place_effect
...
def create_xsq_from_template(
    ...
    if seq_type == "Media" and audio_path:
        ...
        generate_downbeats_track(y, sr, display_elem, element_effects, seq_duration_ms)
    ...
    num_pinwheel_added = add_pinwheel_effects(eligible_elements, eligible_group_elements, seq_duration_ms,
                                              color_palettes, colors, beats, structure, registry=registry)
    num_single_strand_added = add_single_strand_effects(eligible_elements, eligible_group_elements, seq_duration_ms,
                                                        color_palettes, colors, beats, structure, registry=registry)
    num_morph_added    = add_morph_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_fill_added     = add_fill_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_ripple_added   = add_ripple_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_wave_added     = add_wave_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_twinkle_added  = add_twinkle_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_meteors_added  = add_meteors_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_fire_added     = add_fire_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_shimmer_added  = add_shimmer_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_strobe_added   = add_strobe_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_fan_added      = add_fan_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_galaxy_added   = add_galaxy_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_shape_added    = add_shape_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_warp_added       = add_warp_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_marquee_added    = add_marquee_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_curtain_added    = add_curtain_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_butterfly_added  = add_butterfly_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_snowflakes_added = add_snowflakes_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_garlands_added     = add_garlands_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_spirograph_added   = add_spirograph_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_lightning_added    = add_lightning_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_circles_added      = add_circles_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_kaleidoscope_added = add_kaleidoscope_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_liquid_added       = add_liquid_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_plasma_added       = add_plasma_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_fireworks_added    = add_fireworks_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
    num_tendril_added      = add_tendril_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, colors, beats, structure, registry=registry)
