...
def create_xsq_from_template(template_xsq,
    ...
    if display_elem is None or element_effects is None or color_palettes is None:
    ...
    if head is not None:
        ...
        if seq_dur_elem is not None:
            seq_dur_elem.text = f"{duration}.000"
    ...
    print(f"\n✅ Created structured sequence: {output_xsq}")
    ...
    print(f"Generated {num_ons_added + num_bars_added + num_color_wash_added} custom palettes for effects")
