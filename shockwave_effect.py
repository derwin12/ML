...
def _place_shockwave(effect_layer, start_time, end_time, color_palettes, fixed_colors, is_group, registry=None, structure=None):
...
def add_shockwave_effects(eligible_elements, eligible_group_elements, seq_duration_ms, color_palettes, fixed_colors, beats=None, structure=None, registry=None):
        ...
        for elem in eligible_group_elements:
            for start_time, end_time in beat_placements:
                ...
                if effect_layer is None:
                    continue
                _place_shockwave(effect_layer, start_time, end_time, color_palettes, fixed_colors, True, registry, structure)
        ...
        if eligible_elements:
            ...
            for elem in alt_elements:
                for start_time, end_time in beat_placements:
                    ...
                    if effect_layer is None:
                        continue
                    _place_shockwave(effect_layer, start_time, end_time, color_palettes, fixed_colors, False, registry, structure)
                    num_shockwave_added += 1
    ...
    for start_time, end_time in placements:
        ...
        if effect_layer is None:
            continue
        _place_shockwave(effect_layer, start_time, end_time, color_palettes, fixed_colors, is_group, registry)
        num_shockwave_added += 1
